...
async def loop_process(websocket):
    ...
    # layout_model = YOLOv10("C:/Users/Colin/Desktop/live_desktop_translator/python_server/external_projects/DocLayout-YOLO/doclayout_yolo_docstructbench_imgsz1024.pt")

    # from ultralyticsv10 import YOLOv10
    # layout_model = YOLOv10("C:/Users/Colin/Desktop/live_desktop_translator/python_server/external_projects/moured/yolov10/yolov10x_best.pt")

    from ultralytics import YOLO
    layout_model = YOLO("C:/Users/Colin/Desktop/live_desktop_translator/python_server/external_projects/moured/yolov11/yolov11x_best.pt")
        ...
        while True:
            ...
            if params["is_running"]:
                ...
                if current_screenshot.shape != np_screenshot.shape or not (current_screenshot == np_screenshot).all():
                    ...
                    det_res = layout_model.predict(current_screenshot, device="cuda:0")
                    # bounding_boxes = det_res[0].boxes.xywh.cpu().numpy()

                    await websocket.send(json.dumps({"plot_bounding_boxes": det_res[0].to_json()}))
